...
const ConverterForm = () => {
    ...
    //Swap the value of fromCurrency and toCurrency
    ...
    //Function to Fetch the exchange rate and update result
    ...
    //Hendle from submission
    const handleFormSubmit = (e) =>{
        e.preventDefault();
        getExchangeRate();
    }

    // fetch exchanger rate on initial render
